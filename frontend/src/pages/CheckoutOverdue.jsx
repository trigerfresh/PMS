    ...
    <Container fluid className="page-container" style={{
      ...
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 mt-2 gap-3 gap-md-0">
        ...
        >
          ...
          {/* Checkout Soon */}
          <div
            onClick={() => navigate(`/booking-details/${hotelId || 'all'}/checkout_soon`)}
            style={{ cursor: 'pointer', transition: '0.2s', border: '1px solid #e2e8f0' }}
          ...
          <div
            ...
            className="px-2 py-1 rounded-3 d-flex align-items-center gap-1 shadow-sm flex-shrink-0 bg-danger text-white"
          >
            <span className="fw-bold" style={{ fontSize: '0.7rem', textTransform: 'uppercase' }}>Overdue</span>
            <span className="badge bg-white text-danger rounded-pill" style={{ fontSize: '0.65rem' }}>{overallCounts.overdue}</span>
          </div>
        </div>
                ...
                return (
                  <tr key={item.booking_id || item.id || index}>
                    ...
                    <td className="px-4 py-3">
                      <Badge bg="danger" className="px-3 py-2 rounded-pill text-capitalize">
                        Overdue
                      </Badge>
                    </td>
                    <td className="px-4 py-3">
                ...
                <div className="mt-2">
                  <Table borderless size="sm" className="mb-0" style={{ fontSize: '0.85rem' }}>
                    <tbody>
                      ...
                      <tr>
                        <td className="text-secondary fw-medium text-start px-0 py-1">Overdue Days</td>
                      ...
                      <tr>
                        <td className="text-secondary fw-medium text-start px-0 py-1">Rate (Per Day)</td>
                        <td className="text-dark text-start ps-3 py-1">₹ {info?.perDayRate?.toFixed(2)}</td>
                      </tr>
                      <tr>
                        <td className="text-secondary fw-medium text-start px-0 py-1">Base Amount</td>
                        <td className="text-dark text-start ps-3 py-1">₹ {totalAmount}</td>
                      </tr>
                      <tr>
                        <td className="text-danger fw-medium text-start px-0 py-1">Overdue Charge</td>
                        <td className="text-danger fw-medium text-start ps-3 py-1">+ ₹ {overdueAmount}</td>
                      </tr>
                    </tbody>
                  </Table>
                  <div className="mt-2 pt-2 border-top d-flex justify-content-between align-items-center">
                    ...
                    <span className="fw-bold text-danger" style={{ fontSize: '1rem' }}>₹ {finalAmount}</span>
                  </div>
                </div>
              )
            })()}
