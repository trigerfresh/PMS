                ...
                <div className="mt-2">
                  <Table borderless size="sm" className="mb-0" style={{ fontSize: '0.85rem' }}>
                    <tbody>
                      ...
                      <tr>
                        <td className="text-secondary fw-medium text-start px-0 py-1">Remaining Days</td>
                        <td className="text-dark text-start ps-3 py-1">
                          <Badge bg="warning" text="dark">{info?.days} Days</Badge>
                        </td>
                      </tr>
                      <tr>
                        <td className="text-secondary fw-medium text-start px-0 py-1">Base Amount</td>
                        <td className="text-dark text-start ps-3 py-1">₹ {total}</td>
                      </tr>
                      <tr>
                        <td className="text-warning fw-medium text-start px-0 py-1">Extra Charge</td>
                        <td className="text-warning fw-medium text-start ps-3 py-1">+ ₹ {extra}</td>
                      </tr>
                    </tbody>
                  </Table>
                  <div className="mt-2 pt-2 border-top d-flex justify-content-between align-items-center">
                    ...
                    <span className="fw-bold text-warning" style={{ fontSize: '1rem' }}>₹ {final}</span>
                  </div>
                </div>
              )
            })()}
