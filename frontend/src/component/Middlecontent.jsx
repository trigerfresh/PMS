      ...
      <div className="container-fluid">
        <div className="row">
              ...
              <div className="bg-secondary card-body">
                <div className="media static-top-widget">
                  <div className="media-body">
                    ...
                    <h3 className="mb-0">
                      $ <span className="counter">1478</span>
          ...
          <div className="col-xl-4 xl-100">
            <div className="card height-equal" style={{ minHeight: '431px' }}>
              ...
              <div className="card-body">
                <div className="order-timeline">
                  <div className="media">
                    ...
                    <div className="media-body">
                      <span className="font-primary">Delivered</span>
                      <p>56 mins ago</p>
                    </div>
                    <span className="pull-right text-muted">Today</span>
                  </div>
                  <div className="media">
                    ...
                    <div className="media-body">
                      <span className="font-secondary">In Transit</span>
                      <p>18 Hour ago</p>
                    </div>
                    <span className="pull-right text-muted">Yesterday</span>
                  </div>
                  <div className="media">
                    ...
                    <div className="media-body">
                      <span className="font-warning">Dispatched</span>
                      <p>3 Days Ago</p>
                    </div>
                    <span className="pull-right text-muted">12 Sep</span>
                  </div>
                  <div className="media">
                    ...
                    <div className="media-body">
                      <span className="font-success">Order Received</span>
                      <p>8 Days Ago</p>
                    </div>
                    <span className="pull-right text-muted">05 Sep</span>
                  </div>
                </div>
                  ...
                  <pre className="  language-html">
                    <code className="  language-html" id="example-head4">
                      ...
                      <span className="token tag">
                        ...
                        <span className="token attr-value">
                          <span className="token punctuation">=</span>
                          <span className="token punctuation">"</span>media
                          <span className="token punctuation">"</span>
                        </span>
                        <span className="token punctuation">&gt;</span>
                      </span>
                      ...
                      <span className="token tag">
                        ...
                        <span className="token attr-name">data-feather</span>
                        <span className="token attr-value">
                          <span className="token punctuation">=</span>
                          <span className="token punctuation">"</span>
                          map-pin
                      ...
                      <span className="token tag">
                        ...
                        <span className="token attr-value">
                          <span className="token punctuation">=</span>
                          <span className="token punctuation">"</span>box
                          <span className="token punctuation">"</span>
                        </span>
                        <span className="token punctuation">&gt;</span>
                      </span>
            ...
            <div className="card btn-months">
              <div className="card-header">
                ...
                <div className="dashboard-btn-groups">
                  ...
                  >
                    <button
                      className="btn btn-outline-light btn-js"
                      type="button"
                    >
                      Day
                    </button>
                    ...
                    <button
                      className="btn btn-outline-light btn-js active"
                      type="button"
                    >
                      Month
                    </button>
              ...
              <div className="card-body">
                  ...
                  >
                    ...
                    <g>
                      <g className="ct-series ct-series-a">
                        <line
                          x1="53.30757945667613"
                          x2="53.25757945667613"
                          y1="256"
                          y2="95.33333333333334"
                          className="ct-bar"
                          ct:value="400"
                          style={{
                            strokeWidth: '15px',
                        ...
                        ></line>
                        <line
                          x1="159.82273837002842"
                          x2="159.7727383700284"
                          y1="256"
                          y2="23.03333333333333"
                          className="ct-bar"
                          ct:value="580"
                          style={{
                            strokeWidth: '15px',
                        ...
                        ></line>
                        <line
                          x1="266.3378972833807"
                          x2="266.2878972833807"
                          y1="256"
                          y2="175.66666666666669"
                          className="ct-bar"
                          ct:value="200"
                          style={{
                            strokeWidth: '15px',
                        ...
                        ></line>
                        <line
                          x1="372.85305619673295"
                          x2="372.80305619673294"
                          y1="256"
                          y2="75.25"
                          className="ct-bar"
                          ct:value="450"
                        ...
                        ></line>
                        <line
                          x1="479.3682151100852"
                          x2="479.3182151100852"
                          y1="256"
                          y2="15"
                          className="ct-bar"
                          ct:value="650"
                        ...
                        ></line>
                        <line
                          x1="585.8833740234375"
                          x2="585.8333740234375"
                          y1="256"
                          y2="95.33333333333334"
                          className="ct-bar"
                          ct:value="400"
                      ...
                      <g className="ct-series ct-series-b">
                        <line
                          x1="692.3985329367897"
                          x2="692.3485329367898"
                          y1="256"
                          y2="55.16666666666666"
                          className="ct-bar"
                          ct:value="500"
                          style={{
                            strokeWidth: '15px',
                        ...
                        ></line>
                        <line
                          x1="905.4288507634942"
                          x2="905.3788507634943"
                          y1="256"
                          y2="63.19999999999999"
                          className="ct-bar"
                          ct:value="480"
                          style={{
                            strokeWidth: '15px',
                        ...
                        ></line>
                        <line
                          x1="1011.9440096768465"
                          x2="1011.8940096768465"
                          y1="256"
                          y2="15"
                          className="ct-bar"
                          ct:value="600"
                        ...
                        ></line>
                        <line
                          x1="1118.459168590199"
                          x2="1118.409168590199"
                          y1="256"
                          y2="115.41666666666666"
                          className="ct-bar"
                          ct:value="350"
                          style={{
                            strokeWidth: '15px',
                    ...
                    <g className="ct-labels">
                      ...
                      <foreignObject
                        style={{ overflow: 'visible' }}
                        x="213.03031782670453"
                        y="261"
                        width="106.51515891335228"
                        height="20"
                      >
                        <span
                          className="ct-label ct-horizontal ct-end"
                      ...
                      <foreignObject
                        style={{ overflow: 'visible' }}
                        x="426.06063565340907"
                        y="261"
                        width="106.51515891335231"
                        height="20"
                      >
                        <span
                          className="ct-label ct-horizontal ct-end"
                ...
                <div className="code-box-copy">
                  ...
                  <pre className="  language-html">
                    <code className="  language-html" id="example-head8">
                      <span className="token tag">
                        <span className="token tag">
                          <span className="token punctuation">&lt;</span>div
                        </span>{' '}
            ...
            <div className="card">
              <div className="card-header">
                ...
                <div className="chart-value-box pull-right">
                  <div className="value-square-box-success"></div>
                  <span className="f-12 f-w-600">Physical</span>
                  <div className="value-square-box-secondary ms-3"></div>
                  <span className="f-12 f-w-600">Digital</span>
                </div>
                <div className="card-header-right">
                  <ul className="list-unstyled card-option">
                    <li>
                ...
                <div className="market-chart">
                  ...
                  >
                    <g className="ct-grids">
                      ...
                      ></line>
                      <line
                        y1="249.54545454545456"
                        y2="249.54545454545456"
                        x1="40"
                        x2="869"
                        className="ct-grid ct-vertical"
                      ></line>
                      <line
                        y1="226.0909090909091"
                        y2="226.0909090909091"
                        x1="40"
                        x2="869"
                        className="ct-grid ct-vertical"
                      ></line>
                      <line
                        y1="202.63636363636363"
                        y2="202.63636363636363"
                        x1="40"
                        x2="869"
                        className="ct-grid ct-vertical"
                      ></line>
                      <line
                        y1="179.1818181818182"
                        y2="179.1818181818182"
                        x1="40"
                        x2="869"
                        className="ct-grid ct-vertical"
                      ></line>
                      <line
                        y1="155.72727272727275"
                        y2="155.72727272727275"
                        x1="40"
                        x2="869"
                        className="ct-grid ct-vertical"
                      ></line>
                      <line
                        y1="132.27272727272728"
                        y2="132.27272727272728"
                        x1="40"
                        x2="869"
                        className="ct-grid ct-vertical"
                      ></line>
                      <line
                        y1="108.81818181818181"
                        y2="108.81818181818181"
                        x1="40"
                        x2="869"
                        className="ct-grid ct-vertical"
                      ></line>
                      <line
                        y1="85.36363636363637"
                        y2="85.36363636363637"
                        x1="40"
                        x2="869"
                        className="ct-grid ct-vertical"
                      ></line>
                      <line
                        y1="61.90909090909091"
                        y2="61.90909090909091"
                        x1="40"
                        x2="869"
                        className="ct-grid ct-vertical"
                      ></line>
                      <line
                        y1="38.45454545454547"
                        y2="38.45454545454547"
                        x1="40"
                        x2="869"
                        className="ct-grid ct-vertical"
                      ></line>
                    ...
                    <g className="ct-labels">
                      ...
                      <foreignObject
                        style={{ overflow: 'visible' }}
                        y="249.54545454545456"
                        x="0"
                        height="23.454545454545453"
                        width="30"
                      >
                        <span
                      ...
                      <foreignObject
                        style={{ overflow: 'visible' }}
                        y="108.81818181818181"
                        x="0"
                        height="23.454545454545467"
                        width="30"
                      >
                        <span
                          className="ct-label ct-vertical ct-start"
                  ...
                  <table className="table table-bordernone">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>4</td>
                        <td className="digits">$120.00</td>
                        <td className="font-danger">Direct Deposit</td>
                    ...
                    <code className="  language-html" id="example-head1">
                      <span className="token tag">
                        ...
                        <span className="token attr-value">
                          <span className="token punctuation">=</span>
                          <span className="token punctuation">"</span>
                          user-status table-responsive latest-order-table
                          <span className="token punctuation">"</span>
                        </span>
                        <span className="token punctuation">&gt;</span>
                      </span>
                      ...
                      <span className="token tag">
                        ...
                        <span className="token attr-value">
                          <span className="token punctuation">=</span>
                          <span className="token punctuation">"</span>digits
                          <span className="token punctuation">"</span>
                        </span>
                        <span className="token punctuation">&gt;</span>
                      </span>
              ...
              <div className="card-header">
                ...
                <div className="dashboard-btn-groups">
                  ...
                  >
                    ...
                    <button
                      className="btn btn-outline-light btn-js1 active"
                      type="button"
                    >
                      Month
                    </button>
          ...
          <div className="col-xl-4 xl-50">
            <div className="card customers-card">
              <div className="card-header">
                <h5>New Customers</h5>
                <div className="chart-value-box pull-right">
                  <div className="value-square-box-secondary"></div>
                  <span className="f-12 f-w-600">Customers</span>
                </div>
                <div className="card-header-right">
                  <ul className="list-unstyled card-option">
                    <li>
              ...
              <div className="card-body p-0">
                ...
                >
                  <div id="customers" style={{ minHeight: '405px' }}>
                    <div
                      id="apexchartsmbsljc57"
                      className="apexcharts-canvas apexchartsmbsljc57"
                      style={{ width: '526px', height: '400px' }}
                    >
                      <svg
                        id="SvgjsSvg1226"
                        width="526"
                      ...
                      >
                        ...
                        >
                          <defs id="SvgjsDefs1227">
                            <clipPath id="gridRectMaskmbsljc57">
                              <rect
                                id="SvgjsRect1229"
                                width="345"
                                height="347"
                            ...
                            <clipPath id="gridRectMarkerMaskmbsljc57">
                              <rect
                                id="SvgjsRect1230"
                                width="351"
                                height="353"
                          ...
                          <g id="SvgjsG1232" className="apexcharts-radialbar">
                            <g id="SvgjsG1233">
                              <g id="SvgjsG1234">
                                <g
                                  id="apexcharts-track-0"
                                  className="apexcharts-radialbar-track apexcharts-track"
                                  rel="1"
                                >
                                  <path
                                    id="apexcharts-radialbarTrack-0"
                                    d="M 93.69669593590699 260.30330406409297 A 110.03048780487805 110.03048780487805 0 1 1 249.303304064093 260.30330406409297"
                                    fill="none"
                                    fillOpacity="1"
                                    stroke="rgba(242,242,242,1)"
                                    strokeOpacity="1"
                                    strokeLinecap="butt"
                                    strokeWidth="36.87182926829269"
                                    strokeDasharray="0"
                                    className="apexcharts-radialbar-area"
                                    data-pathorig="M 93.69669593590699 260.30330406409297 A 110.03048780487805 110.03048780487805 0 1 1 249.303304064093 260.30330406409297"
                                  ></path>
                                </g>
                              </g>
                              <g id="SvgjsG1237">
                                <g
                                  id="apexcharts-series-0"
                                  className="apexcharts-series apexcharts-radial-series CustomerxRatio"
                                  rel="1"
                                >
                                  <path
                                    id="apexcharts-radialbar-slice-0"
                                    d="M 93.69669593590699 260.30330406409297 A 110.03048780487805 110.03048780487805 0 1 1 280.17582991487353 165.28743950212825"
                                    fill="none"
                                    fillOpacity="1"
                                    stroke="rgba(49,77,167,1)"
                                    strokeOpacity="1"
                                    strokeLinecap="butt"
                                    strokeWidth="38.01219512195123"
                                    strokeDasharray="4"
                                    className="apexcharts-radialbar-area"
                                    data:angle="216"
                                    data:value="80"
                                    index="0"
                                    j="0"
                                    data-pathorig="M 93.69669593590699 260.30330406409297 A 110.03048780487805 110.03048780487805 0 1 1 280.17582991487353 165.28743950212825"
                                  ></path>
                                </g>
                                <circle
                                  id="SvgjsCircle1238"
                  ...
                  <div className="resize-triggers">
                    <div className="expand-trigger">
                      <div style={{ width: '527px', height: '351px' }}></div>
                    </div>
                ...
                <div className="code-box-copy">
                  ...
                  <pre className="  language-html">
                    <code className="  language-html" id="example-head7">
                      <span className="token tag">
                        <span className="token tag">
                          <span className="token punctuation">&lt;</span>div
                        </span>{' '}
                    ...
                    <code className="  language-html" id="example-head5">
                      <span className="token tag">
                        ...
                        <span className="token attr-value">
                          <span className="token punctuation">=</span>
                          <span className="token punctuation">"</span>
                          user-status table-responsive products-table
                          <span className="token punctuation">"</span>
                        </span>
                        <span className="token punctuation">&gt;</span>
                      </span>
                      ...
                      <span className="token tag">
                        ...
                        <span className="token attr-value">
                          <span className="token punctuation">=</span>
                          <span className="token punctuation">"</span>
                          img-radius align-top m-r-15 rounded-circle blur-up
                          lazyloaded
                          <span className="token punctuation">"</span>
                        </span>{' '}
                      ...
                      <span className="token tag">
                        ...
                        <span className="token style-attr language-css">
                          <span className="token attr-name">
                            {' '}
                          ...
                          <span className="token attr-value">
                            ...
                            <span className="token punctuation">:</span> 8px
                            <span className="token punctuation">;</span>
                          </span>
                          <span className="token punctuation">"</span>
                        </span>
                      ...
                      <span className="token tag">
                        ...
                        <span className="token attr-name">aria-valuenow</span>
                        <span className="token attr-value">
                          <span className="token punctuation">=</span>
                          <span className="token punctuation">"</span>50
                          <span className="token punctuation">"</span>
                        </span>{' '}
                        <span className="token attr-name">aria-valuemin</span>
                        <span className="token attr-value">
                          <span className="token punctuation">=</span>
                          <span className="token punctuation">"</span>0
                          <span className="token punctuation">"</span>
                        </span>{' '}
                        <span className="token attr-name">aria-valuemax</span>
                        <span className="token attr-value">
                          <span className="token punctuation">=</span>
                          <span className="token punctuation">"</span>100
                          <span className="token punctuation">"</span>
                        </span>
                        <span className="token punctuation">&gt;</span>
                      </span>
                      ...
                      <span className="token tag">
                        ...
                        <span className="token style-attr language-css">
                          ...
                          <span className="token attr-value">
                            <span className="token property">width</span>
                            <span className="token punctuation">:</span> 60%
                          </span>
                          <span className="token punctuation">"</span>
                        </span>{' '}
                        <span className="token attr-name">aria-valuenow</span>
                      ...
                      <span className="token tag">
                        ...
                        <span className="token style-attr language-css">
                          ...
                          <span className="token attr-value">
                            <span className="token property">width</span>
                            <span className="token punctuation">:</span> 90%
                          </span>
                          <span className="token punctuation">"</span>
                        </span>{' '}
                        <span className="token attr-name">aria-valuenow</span>
              ...
              <div className="card-body">
                <div className="row">
                  <div className="col-xl-8">
                    <div className="jvector-map-height" id="world">
                      <div
                        className="jvectormap-container"
                        style={{ backgroundColor: 'transparent' }}
                      >
                        <svg width="1207" height="400">
                          <defs></defs>
                          <g transform="scale(0.9076339281926771) translate(214.91564633521062, 0)">
                            <path
                          ...
                          <g>
                            <circle
                              data-index="0"
                              cx="752.9553411944589"
                              cy="204.66386809889138"
                              fill="white"
                              stroke="#505050"
                              fillOpacity="1"
                              strokeWidth="1"
                            ...
                            <circle
                              data-index="1"
                              cx="683.3413339365145"
                              cy="201.1158180594547"
                              fill="white"
                              stroke="#505050"
                              fillOpacity="1"
                              strokeWidth="1"
                            ...
                            <circle
                              data-index="2"
                              cx="751.8864923179542"
                              cy="153.72856044760195"
                              fill="white"
                              stroke="#505050"
                              fillOpacity="1"
                              strokeWidth="1"
                            ...
                            <circle
                              data-index="3"
                              cx="327.12245877630033"
                              cy="124.47652480522028"
                              fill="white"
                              stroke="#505050"
                              fillOpacity="1"
                              strokeWidth="1"
                            ...
                            <circle
                              data-index="4"
                              cx="695.1368513269399"
                              cy="226.0223203100233"
                              fill="white"
                              stroke="#505050"
                              fillOpacity="1"
                              strokeWidth="1"
                            ...
                            <circle
                              data-index="5"
                              cx="694.0232090299634"
                              cy="88.29570771785306"
                              fill="white"
                              stroke="#505050"
                              fillOpacity="1"
                              strokeWidth="1"
                  ...
                  <div className="col-xl-4">
                    <div className="table-responsive map-table">
                ...
                <div className="code-box-copy">
                  ...
                  <pre className="  language-html">
                    <code className="  language-html" id="example-head6">
                      <span className="token tag">
                        <span className="token tag">
                          <span className="token punctuation">&lt;</span>div
                        </span>{' '}
                      ...
                      <span className="token tag">
                        ...
                        <span className="token attr-value">
                          <span className="token punctuation">=</span>
                          <span className="token punctuation">"</span>world
                          <span className="token punctuation">"</span>
                        </span>
                        <span className="token punctuation">&gt;</span>
                      </span>
